  ...
  return (
    <main className="flex min-h-screen flex-col items-center">
      <div className=" justify-between p-8 max-w-5xl justify-center">
        ...
        ИР е състояние, при което клетките в организма стават по-малко отзивчиви на действието на инсулин,
        ...
        Инсулиновата резистентност и инсулиновата чувствителност са двете страни на една и съща монета. Ако имате висока 
        <Link1 href="/faq#ir1" text="ИР"> </Link1>, то имате ниска ИЧ. И обратно, ако сте чувствителни към инсулин, имате ниска
        ...
        <Red>но не и протеин на прах. </Red> Протеините могат да помогнат за усвояването на глюкозата и подобряване на инсулиновата чувствителност.
        <br></br>
        ...
        <Heading1 id="122">Има ли храни които повишават инсулина, без да повишат кръвната захар?</Heading1>
        Храни, които предизвикват повишение на инсулина, но не повишават значително кръвната захар, са доста редки. Обикновено, повишената секреция 
        на инсулин е резултат от повишени нива на кръвната захар, тъй като основната роля на инсулина е да регулира гликемията. Въпреки това, 
        някои храни с високо съдържание на протеини могат да повишат инсулиновата секреция в някаква степен, без да предизвикват значително 
        повишение на кръвната захар. Възможно е инсулинът да се отделя в малки количества и при консумация на някои храни, но е малко вероятно 
        това да се случи без никакво повишение на кръвната захар.

        <Heading1 id="122">Какво са <Red>глюкозните и инсулинови пикове</Red> и каква е връзката помежду им?</Heading1>
        Глюкозните пикове се отнасят до бързото повишаване на нивата на кръвната захар (глюкоза) след хранене. Когато консумирате храни, които съдържат
        въглехидрати, те се разграждат до глюкоза в храносмилателната система и отиват в кръвния поток. Това води до бързо повишаване на нивата 
        на кръвната захар. 
        <br></br>
        Инсулиновите пикове, от друга страна, се отнасят до високите нива на инсулин в кръвта, които се наблюдават след глюкозния пик. 
        Връзката между глюкозните и инсулиновите пикове е тясно свързана. Когато нивата на кръвната захар се повишават бързо след хранене, панкреасът 
        реагира като отделя по-голямо количество инсулин, за да помогне на клетките да поглъщат глюкозата. Това води до инсулиновия пик. Накратко: 
        връзката между двете е причинно-следствена и винаги глюкозният пик предхожда инсулиновия пик.
        Прието е пик на КЗ да бъде наричано всяко увоеличение със стойност по-висока от 1,7 mmol/L, а увеличения на КЗ до стойности над 
        7,2 mmol/L са нездравословни. 

        <Heading1 id="1сдфс">Какви са нормалните нива на глюкоза на гладно?</Heading1>
        За оптимални нива се сочат стойности на гладно между 3,3 и 4,7 mmol/L. Статистически излиза, че нормалните нива са не повече от 5,5 mmol/L на гладно.
        От 5,6 до 7 mmol/L са преддиабет и над 7 mmol/L се смятат за диабет.
