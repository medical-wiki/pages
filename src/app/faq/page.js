  ...
  return (
    <main className="flex min-h-screen flex-col items-center">
      <div className=" justify-between p-8 max-w-5xl justify-center">
        ...
        <Heading1 id="ir1">Инсулинова резистентност <Link1 href="/theory#terter" text="(ИР)"> </Link1></Heading1>
        ...
        <Link1 href="/faq#ir1"  text="ИР">ИР</Link1>.
        <br></br>
        ...
        от кръвта. Подобряването на инсулиновата чувствителност е важно за контролирането на нивата на кръвната захар и предотвратяването
        ...
        <Heading1 id="хиперинсулинемия">Какво е инсулинов клирънс?</Heading1>
